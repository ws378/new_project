...
from algorithms.territory_seed_research.src.study_runner import run_projects_territory_study


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run territory seed research for every area in one or more maptools projects.")
    parser.add_argument(
        "--project-dir",
        action="append",
        default=None,
